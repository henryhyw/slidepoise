...
def shape(identifier, box, fill, *, search=None):
    entities.append({"id": identifier, "display_label": identifier.replace("-", " "), "kind": "shape", "shape": "rectangle",
                     "role": "native_presentation_geometry", "bbox_hint": box, "search_bbox_hint": search or box, "geometry_policy": "agent_logical", "z": 1,
                     "meaningful_visible": True, "style_hint": {"fill": fill, "stroke": "none", "stroke_width_px": 0,
                     "style_authority": "agent_visual_observation"}})


text("headline", "Prove the research pilot before scaling AI", [48, 19, 1824, 80], 64, "claim-title", family="Georgia", role="slide_title", search=[43, 35, 1195, 70])
text("pilot-scope", "One practice. 15 consultants. 20 paired research tasks. A 12-week, $25k pilot.", [48, 103, 1824, 48], 32, "subtitle", role="subtitle", search=[45, 129, 1051, 32])
shape("introduction-rule", [48, 165, 1824, 2], "#AAAAAA", search=[47, 184, 1827, 5])
...
shape("decision-band", [48, 793, 1824, 134], "#FFF5ED", search=[47, 805, 1826, 122])
shape("decision-accent", [48, 793, 8, 134], "#FD5108", search=[47, 805, 18, 122])
text("decision-label", "DECISION REQUESTED", [100, 832, 420, 52], 28, "decision-band", bold=True, color="#FD5108", role="call_to_action", middle=True, search=[96, 852, 393, 38])
text("decision-request", "Approve $25k and name a practice sponsor.", [560, 832, 1265, 52], 28, "decision-band", bold=True, role="call_to_action", middle=True, search=[561, 852, 655, 38])
...
groups = [
    ...
    {"id": "funding-decision", "display_label": "Bounded funding approval", "semantic_class": "decision request",
     "group_reason": "The shared decision band gives one concrete investment request.", "bbox_hint": [48, 793, 1824, 134],
