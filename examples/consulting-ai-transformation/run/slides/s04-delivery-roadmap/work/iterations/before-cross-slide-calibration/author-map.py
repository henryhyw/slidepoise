...
text("headline", "Run the pilot through four evidence gates", [48, 17, 1825, 85], 64, "claim-title", family="Georgia", role="slide_title", search=[47, 27, 1205, 71])
text("subtitle", "Owners run the workstreams. Evidence gates release the next phase.", [49, 102, 1824, 50], 32, "subtitle", role="subtitle", search=[48, 109, 958, 40])
shape("introduction-rule", [49, 158, 1818, 2], "#AAAAAA")
...
for n, x, marker_x, week, evidence in [
    ...
    text(f"gate-{n}-evidence", evidence, [x+5, 385, 127, 100], 24, "gate-evidence", role="label", align="center", leading=1.18, search=[x+3, 387, 133, 98])
...
shape("decision-band", [49, 790, 1818, 132], "#FFF5ED")
shape("decision-accent", [49, 790, 8, 132], "#FD5108", z=10)
text("decision-label", "STOP RULE", [99, 830, 291, 52], 28, "decision-band", bold=True, color="#FD5108", role="call_to_action", middle=True, search=[98, 837, 217, 49])
text("decision-message", "No expansion while critical data exceptions remain open.", [407, 830, 1410, 52], 28, "decision-band", bold=True, role="call_to_action", middle=True, search=[406, 843, 834, 42])
...
handoff = {"selected_assets": [], "sources": ["Host-authored illustrative planning model"], "notes": [
