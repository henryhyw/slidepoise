...
text("headline", "Start where value and control readiness meet", [48, 19, 1824, 80], 64, "claim-title", family="Georgia", role="slide_title", search=[30, 29, 1325, 67])
text("subtitle", "Capacity creates the opportunity. Control readiness sets the sequence.", [48, 103, 1824, 48], 32, "subtitle", role="subtitle", search=[31, 115, 1014, 32])
shape("introduction-rule", [48, 165, 1824, 2], "#999DA4", search=[33, 164, 1849, 5])
...
shape("decision-band", [48, 793, 1824, 134], "#FFF5ED", search=[33, 800, 1850, 127])
shape("decision-accent", [48, 793, 8, 134], "#FD5108", search=[33, 800, 21, 127])
text("decision-label", "PILOT BOUNDARY", [100, 832, 420, 52], 28, "decision-band", bold=True, color="#FD5108", role="call_to_action", middle=True,
     search=[100, 846, 305, 41])
text("decision-message", "Start with approved-source research synthesis.", [560, 832, 1265, 52], 28, "decision-band", bold=True, role="call_to_action", middle=True,
