...
- Audience question: Keep the question open.
- Dominant message: Keep the question open.
- Required content:
```json
[
  "A fast answer can close a thought too early.",
  "What am I assuming?",
  "What would change my mind?",
  "The useful conversation begins with a better question.",
  "FIELD NOTES / 02"
]
```
...
```json
{
  "audience_question": "Keep the question open.",
  "dominant_message": "Keep the question open.",
...
- Attach the same style and asset context sheet reviewed by the user: `/Users/henry/Codes/AI_slide_drafting/examples/personal-thinking-system/run/slides/s02-question/work/generation-context-sheet.png`.
