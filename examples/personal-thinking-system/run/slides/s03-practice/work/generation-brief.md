...
- Audience question: Collect. Connect. Challenge.
- Dominant message: Collect. Connect. Challenge.
- Required content:
```json
[
  "Collect",
  ...
  "Connect",
  "Put distant ideas in contact.",
  "Challenge",
  "Ask what the pattern leaves out.",
  "Three moves for a thought worth keeping.",
  "FIELD NOTES / 03"
]
```
...
```json
{
  "audience_question": "Collect. Connect. Challenge.",
  "dominant_message": "Collect. Connect. Challenge.",
...
- Attach the same style and asset context sheet reviewed by the user: `/Users/henry/Codes/AI_slide_drafting/examples/personal-thinking-system/run/slides/s03-practice/work/generation-context-sheet.png`.
