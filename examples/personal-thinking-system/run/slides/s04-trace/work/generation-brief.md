...
- Audience question: Leave a trace of the thinking.
- Dominant message: Leave a trace of the thinking.
- Required content:
```json
[
  "Source",
  ...
  "Question",
  "What does it unsettle?",
  "Counterargument",
  "What is the strongest objection?",
  "Decision",
  "What will I carry forward?",
  "A small record makes a conversation reusable.",
  "FIELD NOTES / 04"
]
```
...
```json
{
  "audience_question": "Leave a trace of the thinking.",
  "dominant_message": "Leave a trace of the thinking.",
...
- Attach the same style and asset context sheet reviewed by the user: `/Users/henry/Codes/AI_slide_drafting/examples/personal-thinking-system/run/slides/s04-trace/work/generation-context-sheet.png`.
