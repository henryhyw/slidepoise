...
3. Resolve the Profile and current-presentation overrides once. Select shared references and reusable resources at deck level, then add page-specific resources only where needed.
